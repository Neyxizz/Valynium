--[[
	 ______ _____ _   _ _____ _________     __	    		________
	|  ____|_   _| \ | |_   _|__   __\ \   / / 	           |_____   |
	| |__    | | |  \| | | |    | |   \ \_/ /  	 __     __      /  /
	|  __|   | | | . ` | | |    | |    \   /   	 \ \   / /    /  /
	| |     _| |_| |\  |_| |_   | |     | |    	  \ \_/ /   /  /____
	|_|    |_____|_| \_|_____|  |_|     |_|    	   \___/   |________|
	
	Source:
		https://github.com/DenizAf4can/FinityV2/blob/main/FinityV2
	Version:
     2.0.0
	Date: 
		December 6th, 2022
...
local listofuiplacement = {
	"main_container",
	"main_containerimage",
	"seperator_color",
	"text_color",
	"category_button_background",
	"category_button_border",
	"checkbox_checked",
	"checkbox_outer",
	"checkbox_inner",
	"slider_color",
	"slider_color_sliding",
	"slider_background",
	"slider_text",
	"texbox_Background",
	...
	"dropdown_text",
	"dropdown_text_hover",
	"dropdown_scrollbar_color",
	"button_background",
	"button_background_hover",
	"button_background_down",
	"scrollbar_color",
}

local filename = "FinityUI v2.lua"

function loadSettings()
	print("Loading Settings")
	local HttpService = game:GetService("HttpService");
	if (readfile and isfile and isfile(filename)) then
		getgenv().FinityUIv2Custom = HttpService:JSONDecode(readfile(filename));
	else
...
function saveSettings()
	...
	local HttpService = game:GetService("HttpService");
	if (writefile) then
		Logsz = HttpService:JSONEncode(FinityUIv2Custom);
...
function startup()
	local pnewplist = {}
	for i,v in pairs(FinityUIv2Custom) do
		pnewplist[i] = v
	end
	if game.CoreGui:FindFirstChild("FinityUI") then 
		game.CoreGui.FinityUI:Destroy()
	end
	for i,v in pairs(listofuiplacement) do
		if game.Workspace:FindFirstChild(v) then
			v:Destroy()
		else
			local asdasdqw = Instance.new("Color3Value", game.Workspace)
			asdasdqw.Name = v
			asdasdqw.Value = 0,0,0
		end
	end
end
...
finity.moon_theme = { -- moon
	main_container = Color3.fromRGB(0, 0, 0),
	main_containerimage = "http://www.roblox.com/asset/?id=11764114110",
	separator_color = Color3.fromRGB(255, 255, 255),

	text_color = Color3.fromRGB(255, 255, 255),

	category_button_background = Color3.fromRGB(220, 220, 220),
	category_button_border = Color3.fromRGB(255, 255, 255),

	checkbox_checked = Color3.fromRGB(132, 255, 130),
	checkbox_outer = Color3.fromRGB(220, 220, 220),
	checkbox_inner = Color3.fromRGB(240, 240, 240),
	...
	textbox_background = Color3.fromRGB(200, 200, 200),
	textbox_background_hover = Color3.fromRGB(137, 137, 141),
	textbox_text = Color3.fromRGB(195, 195, 195),
	textbox_text_hover = Color3.fromRGB(232, 232, 232),
	textbox_placeholder = Color3.fromRGB(135, 135, 138),

	dropdown_background = Color3.fromRGB(255, 255, 255),
	dropdown_text = Color3.fromRGB(195, 195, 195),
	dropdown_text_hover = Color3.fromRGB(232, 232, 232),
	dropdown_scrollbar_color = Color3.fromRGB(118, 118, 121),
	
	button_background = Color3.fromRGB(220, 220, 220),
	button_background_hover = Color3.fromRGB(225, 225, 225),
	button_background_down = Color3.fromRGB(240, 240, 240),
	
	scrollbar_color = Color3.fromRGB(255, 255, 255),
}

finity.blueforest_theme = { -- blueforest
	main_container = Color3.fromRGB(0, 0, 0),
	main_containerimage = "http://www.roblox.com/asset/?id=11784464683",
	separator_color = Color3.fromRGB(255, 255, 255),
...
finity.whitegalaxy_theme = { -- whitegalaxy
	main_container = Color3.fromRGB(0, 0, 0),
	main_containerimage = "http://www.roblox.com/asset/?id=11785111194",
	separator_color = Color3.fromRGB(63, 63, 65),
	...
	checkbox_checked = Color3.fromRGB(132, 255, 130),
	checkbox_outer = Color3.fromRGB(120, 120, 120),
	checkbox_inner = Color3.fromRGB(132, 132, 136),
...
finity.custom_theme = {
	main_container = Color3.fromRGB(255, 255, 255),
	main_containerimage = "",
	separator_color = Color3.fromRGB(63, 63, 65),
...
function finity.new(themename, gprojectName, thinProject)
	local finityObject = {}
	...
	local theme = finity.light_theme
	local projectName = false
	local thinMenu = false
	local toggledKey = Enum.KeyCode.End
	
    if string.lower(themename) == "light" then theme = finity.light_theme end
	if string.lower(themename) == "dark" then theme = finity.dark_theme end
    if string.lower(themename) == "moon" then theme = finity.moon_theme end
	if string.lower(themename) == "blueforest" then theme = finity.blueforest_theme end
	if string.lower(themename) == "whitegalaxy" then theme = finity.whitegalaxy_theme end
	...
	self2.container = self:Create("ImageLabel", {
		...
		ZIndex = 2,
		Image = theme.main_containerimage,
		ImageTransparency = 0
    })
